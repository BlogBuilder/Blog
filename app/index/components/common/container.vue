            ...
            <!--</svg>-->
              ...
              <!--</svg>-->
                    ...
                    <div id="loading-center-absolute">
                        <div class="object" id="object_one" style="left:20px;background:#1ccdca"></div>
                        <div class="object" id="object_two" style="left:20px;background:#1ccdca" ></div>
                        <div class="object" id="object_three" style="left:40px;background:#1ccdca"></div>
                        <div class="object" id="object_four" style="left:60px;background:#1ccdca"></div>
                        <div class="object" id="object_five" style="left:80px;background:#1ccdca"></div>
                    </div>
